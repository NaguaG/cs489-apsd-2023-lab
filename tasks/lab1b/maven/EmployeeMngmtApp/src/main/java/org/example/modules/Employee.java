...
public class Employee {
    ...
    public boolean isUpcomingEnrollee(){
        ...
        var nextMonthYear = nextMonthDate.getYear();
        var nextMonthMonth = nextMonthDate.getMonth();

        var quialifiedDate = employmentDate.plusYears(5L);
        return ((quialifiedDate.getYear() == nextMonthYear) && quialifiedDate.getMonth().equals(nextMonthMonth) && pensionPlan == null);
    }
    @Override
